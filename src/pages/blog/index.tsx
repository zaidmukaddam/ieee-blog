...
export const getStaticProps = async () => {
  const allPosts = getDocuments('posts', ['title', 'publishedAt', 'slug', 'coverImage', 'description', 'author'])
      ...
      <main className="mx-auto flex w-full max-w-screen-sm flex-col gap-5 px-6 lg:px-0">
        <div className="flex flex-col gap-2">
          ...
          <p className="lg:text-lg">
            This blog is a collection of expriences, learnings, and thoughts. Sometimes{' '}
